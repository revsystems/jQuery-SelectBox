...
function positionSB(){var $ddCtx=getDDCtx();var ddMaxHeight=0;var ddY=0;var dir="";$dd.removeClass("above");$dd.css({display:"block",maxHeight:"none",position:"relative",visibility:"hidden"});if(o.fixedWidth)$dd.width($display.outerWidth()-$dd.extraWidth()+1);var bottomSpace=$(window).scrollTop()+$(window).height()-$display.offset().top-$display.outerHeight();var topSpace=$display.offset().top-$(window).scrollTop();var bottomOffset=$display.offsetFrom($ddCtx).top+$display.outerHeight();var spaceDiff=bottomSpace-topSpace+o.dropupThreshold;if($dd.outerHeight()<bottomSpace){ddMaxHeight=o.maxHeight?o.maxHeight:bottomSpace;ddY=bottomOffset;dir="down";}
